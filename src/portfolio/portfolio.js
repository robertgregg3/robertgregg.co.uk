...
const portfolioItemData = [
    ...
    },    
    {
        ...
        skill8: 'mongodb',
        skill9: 'nodejs',
        details: 'A video rental app with CRUD operations, using the REST Api to add, delete, save or update a movie. React navigation routing, pagination, filtering, sorting and form validation, tohether with bootstrap styling',
